...
module StormShamanSpells
    ...
    set staticCharge.info = "Static Charge|n|cfff4a460Target|r: |cff3399ffPassive|n|r|cfff4a460Damage|r: |cff3399ff(20% + 5% x level) Max HP|n|r|nAny time Storm Shaman is a target of a direct enemy spell he releases a Static Charge that deals decent amount of damage to the caster based on the caster's Max HP."

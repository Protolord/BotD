...
module GargoyleSpells
    ...
    set terror.info = "Terror|n|cfff4a460Target|r: |cff3399ffSelf (400)|n|r|cfff4a460Damage|r: |cff3399ff(35 x ability level)|n|r|cfff4a460Cooldown|r: |cff3399ff15 seconds|r|n|nGargoyle creates a horrifying scream which damages nearby enemy units and makes them to run away 250 range away."
    ...
    set rockHard.info = "Rock Hard|n|cfff4a460Target|r: |cff3399ffPassive|n|r|cfff4a460Reduction|r: |cff3399ff(1 damage + (0.5 x ability level))|r|n|nGargoyle rock hard skin can reduce damage from incoming ranged attacks."

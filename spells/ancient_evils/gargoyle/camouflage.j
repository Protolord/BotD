    ...
    struct Camouflage extends array
        ...
        private static method onDamage takes nothing returns nothing
            if Damage.type == DAMAGE_TYPE_PHYSICAL and IsUnitInGroup(Damage.source, thistype.g) then
                call Stun.create(Damage.target, StunDuration(GetUnitAbilityLevel(Damage.source, SPELL_ID)), SILENCE_STACK)
        ...
        private static method onCast takes nothing returns nothing
            ...
            set this.ms = Movespeed.create(this.caster, -Slow(GetUnitAbilityLevel(this.caster, SPELL_ID)), 0)

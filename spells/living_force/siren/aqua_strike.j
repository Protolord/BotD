scope AquaStrike
    ...
    globals
        private constant integer SPELL_ID = 'AHH2'
        private constant string MODEL = "Models\\Effects\\AquaStrike.mdx"
    ...
    struct AquaStrike extends array
        ...
        private static method onHit takes nothing returns nothing
            ...
            elseif TargetFilter(this.target, this.owner) then
                call Damage.element.apply(this.caster, this.target, DamageDealt(this.lvl), ATTACK_TYPE, DAMAGE_TYPE, DAMAGE_ELEMENT_WATER)
            endif
            call this.destroy()
        endmethod

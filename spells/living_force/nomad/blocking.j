scope Blocking
    ...
    struct Blocking extends array
        ...
        private static method onDamage takes nothing returns nothing
            ...
            local real tx
            local real ty
            if Damage.type == DAMAGE_TYPE_PHYSICAL and not Damage.coded and CombatStat.getAttackType(Damage.source) != ATTACK_TYPE_MAGIC and thistype.tb.has(GetHandleId(Damage.target)) and CombatStat.isMelee(Damage.source) then
                set Damage.amount = 0

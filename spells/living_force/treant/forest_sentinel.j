scope ForestSentinel

    globals
        private constant integer SPELL_ID = 'AHK2'
        private constant string MODEL = "Models\\Effects\\ForestSentinel.mdl"
    ...
    private struct SpellBuff extends Buff
        ...
        private static constant integer RAWCODE = 'DHK2'
        ...
        private static method onPeriod takes nothing returns nothing
            ...
            call Damage.element.apply(this.source, this.target, this.dmg, ATTACK_TYPE, DAMAGE_TYPE, DAMAGE_ELEMENT_PLANT)
        endmethod

        method onApply takes nothing returns nothing
            set this.t = NewTimerEx(this)
            set this.dmg = DamagePerSecond(GetUnitAbilityLevel(this.source, SPELL_ID))*TIMEOUT
    ...
    struct ForestSentinel extends array

scope EnergyField
    ...
    globals
        private constant integer SPELL_ID = 'AHE3'
    ...
    struct EnergyField extends array
        implement Alloc
        ...
        private static method onPeriod takes nothing returns nothing
            ...
            loop
                ...
                if TargetFilter(u, this.owner) then
                    ...
                    call Damage.element.apply(this.caster, u, this.dmg, ATTACK_TYPE, DAMAGE_TYPE, DAMAGE_ELEMENT_ARCANE)
                endif
            endloop

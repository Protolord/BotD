    ...
    struct StaticCharge extends array
        ...
        private static method onCast takes nothing returns boolean
            ...
            if lvl > 0 and TargetFilter(caster, GetOwningPlayer(target)) then
                call Damage.element.apply(target, caster, RMinBJ(MaxHPDamage(lvl)*GetUnitState(target, UNIT_STATE_MAX_LIFE)/100, GetWidgetLife(target)), ATTACK_TYPE, DAMAGE_TYPE, DAMAGE_ELEMENT_ELECTRIC)

...
*/
    ...
    private struct CombatStatRegister extends array
        ...
        private static method onInit takes nothing returns nothing
            ...
            call CombatStat.hero('H00D', ATTACK_TYPE_HERO, 30, 2, 12, 100, STAT_INT)
            //call CombatStat.hero('H00E', ATTACK_TYPE_HERO, 30, 2, 12, 100, STAT_INT)
            //call CombatStat.hero('H00F', ATTACK_TYPE_HERO, 30, 2, 12, 100, STAT_INT)
